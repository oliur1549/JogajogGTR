...
public class SaveContactShow {
    ...
    public SaveContactShow() {
    }

    public SaveContactShow(Integer contactId, String name, Integer custId, String designation, String email, String phoneNumber, String dateAdded, String dateUpdated, Integer addedByUserId, Integer updateByUserId, CompanyProfile customer) {
