...
public class DemoTest2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_test2);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(DemoTest2Activity.this,ItemPreviewActivity.class).putExtra("items",itemsModelListFiltered.get(position)));
